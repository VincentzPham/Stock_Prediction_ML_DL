...
class ExponentialSmoothingModel(BaseModel):
    ...
    def build(
        ...
        **kwargs
        ...
        self.seasonal_periods = seasonal_periods or self.config.get('seasonal_periods', None)
        
        print(f"Exponential Smoothing configured: trend={self.trend}, seasonal={self.seasonal}")
    ...
    def train(
        ...
        **kwargs
        ...
        if seasonal_periods and len(train_series) < 2 * seasonal_periods:
            print(f"  Warning: Data too short for seasonality, disabling...")
            seasonal = None
