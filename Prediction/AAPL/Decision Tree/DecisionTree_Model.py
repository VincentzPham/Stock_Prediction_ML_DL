...
# output_dir_result = os.path.join(output_dir, 'Result/AAPL/Decision Tree/')
# if not os.path.exists(output_dir_result):
#     os.makedirs(output_dir_result, exist_ok=True)

# output_dir_models = os.path.join(output_dir, 'Models/AAPL/Decision Tree/')
...
# # Huấn luyện mô hình
# dt_model = DecisionTreeRegressor(random_state=42)  # Sử dụng DecisionTreeRegressor với seed để tái lập
...
# model_path = os.path.join(output_dir_models, 'dt_model.pkl')
...
# # 3. Thêm plot cây quyết định (Decision Tree visualization)
# plt.figure(figsize=(20, 10))  # Kích thước lớn để dễ xem
# plot_tree(dt_model, feature_names=features, filled=True, rounded=True, fontsize=10)
# plt.title('Decision Tree Visualization')
# plt.tight_layout()
# tree_plot_path = os.path.join(output_dir_result, 'decision_tree_plot.png')
...
#     'R2 Score': r2
# }])
# metrics_csv_path = os.path.join(output_dir_result, 'dt_metrics.csv')
...
# print('Đã lưu decision tree plot:', tree_plot_path)
